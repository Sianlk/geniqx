...
const ACTIONS = [
  { id: '1', title: 'Quantum Circuits', icon: 'sparkles-outline' },
  { id: '2', title: 'QML Engine', icon: 'sparkles-outline' },
  { id: '3', title: 'Quantum Crypto', icon: 'sparkles-outline' },
  { id: '4', title: 'Optimization AI', icon: 'sparkles-outline' },
  { id: '5', title: 'Q-Simulator', icon: 'sparkles-outline' },
];
