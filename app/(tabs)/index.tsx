...
const QUICK_ACTIONS = [
        { id: '1', title: 'Quantum Circuits', icon: 'sparkles-outline', color: Colors.primary },
        { id: '2', title: 'QML Engine', icon: 'sparkles-outline', color: Colors.primary },
        { id: '3', title: 'Quantum Crypto', icon: 'sparkles-outline', color: Colors.primary },
        { id: '4', title: 'Optimization AI', icon: 'sparkles-outline', color: Colors.primary },
        { id: '5', title: 'Q-Simulator', icon: 'sparkles-outline', color: Colors.primary },
];
...
export default function HomeScreen() {
  ...
  async function handleAIQuery() {
    ...
    setLoading(true);
    Analytics.aiQuery(prompt, 'quantum AI');
    try {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.tagline}>Quantum intelligence meets AI</Text>
        </View>
      ...
      <Card variant="ai" style={styles.aiCard}>
        <View style={styles.aiBadge}>
          ...
          <Text style={styles.aiBadgeText}>AI — quantum AI</Text>
        </View>
        <TextInput
          style={styles.aiInput}
          placeholder={`Ask GeniQX AI anything...`}
