...
export default function AIScreen() {
  ...
  const [taskType, setTaskType] = useState('Quantum Circuits');
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>Domain: quantum AI</Text>

      <Card variant="ai" style={styles.card}>
        <Text style={styles.label}>Task Type</Text>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.tagRow}>
          {['Quantum Circuits','QML Engine','Quantum Crypto','Optimization AI','Q-Simulator'].map((f) => (
            <TouchableOpacity
              key={f}
