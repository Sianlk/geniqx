...
<img src="assets/graphics/icon-1024.svg" width="120" alt="GeniQX Icon" />

# GeniQX

### Quantum AI. Limitless Potential.

[![CI](https://github.com/Sianlk/geniqx/actions/workflows/backend-ci.yml/badge.svg)](https://github.com/Sianlk/geniqx/actions/workflows/backend-ci.yml)
[![Security Scan](https://github.com/Sianlk/geniqx/actions/workflows/security-scan.yml/badge.svg)](https://github.com/Sianlk/geniqx/actions/workflows/security-scan.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Platform](https://img.shields.io/badge/platform-iOS%20|%20Android-lightgrey.svg)](https://geniqx.ai)
[![FastAPI](https://img.shields.io/badge/backend-FastAPI-009688.svg)](https://fastapi.tiangolo.com)
[![React Native](https://img.shields.io/badge/mobile-React%20Native-61DAFB.svg)](https://reactnative.dev)

**quantum AI, next-gen intelligence**

[Website](https://geniqx.ai) · [Privacy Policy](https://geniqx.ai/privacy) · [Support](https://geniqx.ai/support)
...
**GeniQX** — Quantum AI. Limitless Potential.
...
- **AI-Powered Core** — Intelligent automation and recommendations tailored to quantum AI
