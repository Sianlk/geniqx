...
const styles = StyleSheet.create({
  ...
  // Variants
  variant_primary:   { backgroundColor: '#06B6D4' },
  variant_secondary: { backgroundColor: '#22D3EE33' },
  variant_outline:   { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#06B6D4' },
  variant_ghost:     { backgroundColor: 'transparent' },
  variant_danger:    { backgroundColor: Colors.error },
  variant_ai:        { backgroundColor: '#0891B2', borderWidth: 1, borderColor: '#22D3EE' },

  // Labels
  label: { ...Typography.button },
  label_primary:   { color: '#FFFFFF' },
  label_secondary: { color: '#0891B2' },
  label_outline:   { color: '#06B6D4' },
  label_ghost:     { color: '#06B6D4' },
