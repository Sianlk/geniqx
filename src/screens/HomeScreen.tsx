    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.header}>
          ...
          <Text style={styles.tagline}>Quantum AI. Limitless Potential.</Text>
        </View>
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Quick Access</Text>
        <View key="0" style={styles.featureCard}>
          <Text style={styles.featureText}>Quantum Computing</Text>
        </View>
        <View key="1" style={styles.featureCard}>
          <Text style={styles.featureText}>AI Pipeline</Text>
        </View>
        <View key="2" style={styles.featureCard}>
          <Text style={styles.featureText}>Advanced Analytics</Text>
        </View>
        <View key="3" style={styles.featureCard}>
          <Text style={styles.featureText}>Enterprise Scale</Text>
        </View>
        </View>
        {user && (
